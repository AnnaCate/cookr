...
export default function Login() {
  ...
  return (
    <div className="mt-48 mx-10 relative">
      <h1 className="font-sacramento w-full text-7xl text-center">cookr</h1>
      <form
      ...
      <p className="italic w-full mx-auto text-center">
        Hint: it's the name of Anna's dog, all lowercase.
      </p>
