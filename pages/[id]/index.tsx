...
export default function RecipeDetails({ recipe }: { recipe: Recipe.Existing }) {
          ...
          >
            ...
            <div>
              ...
              {recipe.ingredients.map((ingr) => (
                <div className="mb-3" key={ingr.id}>
  ...
  return {
    props: {
      recipe: {
        ...
        ingredients: recipe.ingredients.map((v: Recipe.IngredientSection) => ({
          ...v,
          _id: v._id!.toString(),
        })),
        submittedBy: {
